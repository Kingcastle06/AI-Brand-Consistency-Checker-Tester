# Shared Module Contracts For AI Brand Consistency Checker

This folder contains only the shared module contracts applicable to AI Brand Consistency Checker.
