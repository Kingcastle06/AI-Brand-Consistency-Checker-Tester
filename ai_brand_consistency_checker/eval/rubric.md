# AI Brand Consistency Checker Evaluation Rubric

Use this rubric for the Python evaluation runner, normally `python -m ai_brand_consistency_checker.eval.run_eval --fixtures fixtures/golden --rubric eval/rubric.md`, or the documented project-equivalent evaluation command.
