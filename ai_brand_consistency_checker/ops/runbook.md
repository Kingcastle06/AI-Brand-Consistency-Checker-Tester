# AI Brand Consistency Checker Runbook
...
- Re-run the evaluation command from `eval/run_eval.md`, usually `python -m ai_brand_consistency_checker.eval.run_eval --fixtures fixtures/golden --rubric eval/rubric.md`.
