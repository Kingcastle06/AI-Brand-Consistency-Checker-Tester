...
This is the starter workspace for the AI Brand Consistency Checker build. Treat the included specification documents as the source of truth, then expand this README as implementation decisions, setup steps, commands, and deployment notes become real.

## Start Here

- Read `specification_ai_brand_consistency_checker.md` for the full product specification.
...
- Run API locally: `python -m ai_brand_consistency_checker.api` or the project-documented equivalent.
- Test: `python -m pytest`
- Security: `python -m pytest tests/security` or the project-documented equivalent.
- Eval: `python -m ai_brand_consistency_checker.eval.run_eval --fixtures fixtures/golden --rubric eval/rubric.md`
...
- `specification_ai_brand_consistency_checker.md`: full project specification and source of truth.
